...
export class V1InitialSchema1710000000000 implements MigrationInterface {
  public readonly name = "V1InitialSchema1710000000000";
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      drop table if exists integration_intake_events;
      ...
      drop table if exists worker_git_repositories;
      drop table if exists client_workers;
