...
export class BaselineSchema1710000000000 implements MigrationInterface {
  public readonly name = "BaselineSchema1710000000000";
  ...
  public async down(): Promise<void> {
    // This migration baselines existing installations. Rollbacks should be explicit
    // follow-up migrations rather than dropping application data.
  }
}
