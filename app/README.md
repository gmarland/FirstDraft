...
React and Vite console for operating a FirstDraft worker fleet. It lets users sign in, create the first user, inspect workers, review the task queue, queue commands, review command history and output, update their profile, and delete their profile.

## Main Workflows

- Sign in, create the first user, update the current user's profile, and delete the current user's profile.
